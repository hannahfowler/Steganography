...
function avg_error=simple_iterate(image_addr, image_type, dim,
cols_protected, redun, iterations)
tests = 10;
...
warning off MATLAB:divideByZero warning off
MATLAB:nearlySingularMatrix warning off MATLAB:singularMatrix
for t=1:tests
t %display the test number
%embed a random message into the image
msg=mark_funct2(image_addr, image_type, dim, cols_protected, redun, iterations);
